...
// The example illustrates using the "existing" term for an existing resource and then also importing an API end-point with OpenDocs specificatons to API management
// ****************************************
